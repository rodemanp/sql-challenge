--1. List the following details of each employee: employee number, last name, first name, gender, and salary. (use inner join)
...
--2. List employees who were hired in 1986. (use extract function - https://www.w3resource.com/PostgreSQL/extract-function.php)
